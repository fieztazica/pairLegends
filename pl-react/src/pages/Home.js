...
export function Home() {
    ...
    const GameButtonGroup = () => (
        ...
        >
            ...
            <Button onClick={() => setOpenHtpDialog(true)} component={Link} startIcon={<QuestionMarkIcon />}>
                How to play
            </Button>
            <Button onClick={() => setOpenCreditsDialog(true)} component={Link} startIcon={<GroupIcon />}>
                Credits
            </Button>
            <Button
                rel="noreferrer"
        ...
        >
            <Container maxWidth="md">
                ...
                >
                    ...
                    <HowToPlayDialog openState={openHtpDialog} onClose={() => setOpenHtpDialog(false)} dref={htpDescriptionElementRef} />
                    <CreditsDialog openState={openCreditsDialog} onClose={() => setOpenCreditsDialog(false)} dref={credDescriptionElementRef} />
                </Box>
            </Container>
        </Box>
    );
